...
-- gears.wallpaper.fit("/home/orion/Downloads/crisalys-anime-1900701-wallhere.com.jpg", , nil)
-- gears.wallpaper.set("#")
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey }, "p",
    function()
      awful.spawn("dmenu_run -fn \"Mono:size=10\" -nb \"#282828\" -nf \"#f1f1f1\" -sb \"#1d2021\" -sf \"#e36783\"")
  end),
