...
run_once({ "xset r rate 210 85", "unclutter -root", "setxkbmap -option caps:swapescape && setxkbmap -option escape:swapcaps", "compton", "bash ~/noaccel.sh" }) -- entries must be separated by commas
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,           }, "r", function () awful.spawn(terminal .. " -e fff") end,
              {description = "open a terminal", group = "launcher"}),
